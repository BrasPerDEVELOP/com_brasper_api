...
# Pares de cambio a los que aplica un cupón. Vivía en world_cup;
# lo usa el flujo normal de cupones, por eso sobrevive al retiro del módulo.
class ExchangeRateScope(str, enum.Enum):
    brl_pen = "BRL_PEN"
    pen_brl = "PEN_BRL"
    usd_brl = "USD_BRL"
    brl_usd = "BRL_USD"
