...
from app.modules.coin.adapters.router.commission_accounting_routes import router as commission_accounting_router
...
router.include_router(commission_accounting_router)
